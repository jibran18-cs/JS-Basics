...
// forEach method does not return the value (It can be done by using forEach but it is difficult. That's why we use filter method)

let val= coding.forEach((items)=>{
    // console.log(items.fileName);
  })
  console.log(val);